...
def _get_workspace() -> str:
    ...
    if _active_workspace and os.path.isdir(_active_workspace):
...
def _get_sandbox():
    ...
    if _sandbox_instance is None:
        ...
        _sandbox_instance = AgentSandbox(
...
def _safe_resolve(base: str, relative: str) -> str:
    """Resolve a relative path under base, raising on traversal attempts."""
